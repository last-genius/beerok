  ...
  constructor(props) {
    ...
    this.state = {
      items: [
        ...
        {
          imgurl:
            "https://image.freepik.com/free-photo/glass-fresh-cold-beer-dark-background_101125-98.jpg",
          name: "Deep-Fried Handlebar Doppelbock",
          description:
            "Groovy dragon's blood that resembles the musky aroma of a goat",
        },
        {
          imgurl:
            "https://il8.picdn.net/shutterstock/videos/1225942/thumb/1.jpg",
          name: "Bursting Blackberry Side Plank Imperial Stout",
          description: "Gassy undertones with a medicinal nose",
        },
        {
          imgurl:
            "https://image.freepik.com/free-photo/beer-mug-beer-dark-background-frosty-glass-light-beer-set_61243-557.jpg",
          name: "Bursting Blackberry Side Plank Imperial Stout",
          description: "Confounding liquid seduction with a british accent",
        },
        {
          imgurl:
            "https://media.istockphoto.com/photos/glass-of-beer-with-black-background-picture-id1009530630?k=6&m=1009530630&s=170667a&w=0&h=q-nPhx38aRod45n8hVfJzwvL-rAb8EsO0PU5qZCaLBQ=",
          name: "Jalapeño Knobby-Tired Imperial Stout",
          description: "Nuanced flavors with hints of processed meat",
        },
        {
          imgurl:
            "http://cdn6.dissolve.com/p/D2057_3_013/D2057_3_013_0004_600.jpg",
          name: "Gooseberry Salution Seal Dunkel",
          description:
            "Delicate mountains of bitterness that conjures fond memories of long summer nights",
        },
        {
          imgurl:
            "https://ak.picdn.net/shutterstock/videos/32300107/thumb/1.jpg",
